...
def load_data():
    ...
    test_dataset = h5py.File('/Users/tanishmalekar/Library/CloudStorage/OneDrive-BajajFinanceLimited/Desktop/Research Paper/server/datasets/test_catvnoncat.h5', "r")
...
## create a func which will take encrypted X input, encrypted parameters and return output. This function will be called on server.
...
indexx =mislabel_index[0]
plt.imshow(train_x[indexx])




test_accuracy, test_predictedValues = predict(test_X, test_Y, parameters)
print(f"Test Data Accuracy: {test_accuracy}")
# More Accuracy can be obtain by training again at lower learning_rate

# Show Mislabeled Image
mislabel_index = mislabel(test_X,test_Y,test_predictedValues)
print("Mislabel Index", mislabel_index)
